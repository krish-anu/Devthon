...
export default function UnderConstructionPage() {
  ...
  return (
    <div className="flex min-h-screen flex-col bg-gradient-to-br from-(--brand) via-(--brand)/80 to-(--brand)/20">
      {/* Header */}
        ...
        <Card className="w-full max-w-lg space-y-6 text-center">
          ...
          <div className="space-y-2">
            ...
            <div className="h-3 w-full overflow-hidden rounded-full bg-gray-200">
              <div className="h-full w-[70%] rounded-full bg-gradient-to-r from-(--brand)/80 to-(--brand) transition-all" />
            </div>
          </div>
