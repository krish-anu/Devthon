  ...
  return (
    ...
    >
      <div className="space-y-6">
        <div className="flex items-center justify-center w-full min-h-screen bg-background px-6 py-6 lg:py-12">
          <ThemeToggle className="fixed right-6 top-6" />
          <Card className="w-full max-w-md space-y-6 p-4 sm:p-6">
