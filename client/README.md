...
## Firebase (optional) 🔧
If you plan to use Firebase client SDKs (Auth, Firestore, Storage, Analytics), add the following **public** keys to your local environment (do not commit secret server credentials):
